 ...
 * pointed at `/m/[matchId]/opengraph-image`, which is the actual PNG WhatsApp
 * will render — the same bytes, from the same route, generated by Satori on
 * the server.
 *
 ...
 *
 * Which is also why the size label below says 1200 × 630 and not the 1080 ×
 * 1080 square on the design. The card that exists is the Open Graph size. A
 * square variant for sending as an image has not been built, and drawing this
 * one boxed into a square would be exactly the drift described above.
 */
