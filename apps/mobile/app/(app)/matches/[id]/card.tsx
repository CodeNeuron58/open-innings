 ...
 * D1 + D2 — the card.
 *
 * Two tabs over one fetch. `/card` is the heavy call — it carries every ball
 * of the match — so it is made once and both views read what is already here.
 * Switching from the scorecard to the over-by-over feed should not hit the
 * network at a ground on mobile data.
 *
 * The commentary in D2 is generated by `describeBall` in the engine, and every
 * clause of it is derived from the ball log. It will say "Kamath to Thomas,
 * FOUR"; it will never say where the shot went, because nothing here watched
