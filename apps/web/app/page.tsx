        ...
        <nav className="container flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="hidden items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-foreground sm:inline-flex"
            >
        ...
        <section className="container grid items-center gap-10 py-16 lg:grid-cols-2 lg:gap-16 lg:py-24">
          <div className="flex flex-col items-start gap-5">
            ...
            <p className="max-w-xl text-balance text-lg text-muted-foreground">
              Ball-by-ball scoring, live shareable scorecards, player careers, teams and
              tournaments — community-owned and donation-funded, like Lichess. No ads, no
              premium tier, no lock-in. Ever.
            </p>
          ...
          <div className="container py-16">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                Commercial scoring apps monetise your club with subscriptions, ads and
                paywalled stats. Open Innings is built the Lichess way — the whole product is
            ...
            <div className="mx-auto max-w-3xl overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <ComparisonRow feature="Live public scorecards" us={true} them="Free tier limits" />
                  <ComparisonRow feature="Full career stats" us={true} them="Often premium" />
                  <ComparisonRow feature="Tournaments & leaderboards" us="v0.2" them="Premium tiers" />
                  <ComparisonRow feature="No ads" us={true} them={false} />
                  <ComparisonRow feature="Open source — audit & contribute" us={true} them={false} />
        ...
        <section className="border-t border-border bg-primary text-primary-foreground">
          <div className="container flex flex-col items-center gap-5 py-16 text-center">
            ...
            <p className="max-w-xl text-balance text-primary-foreground/80">
              Chess got Lichess. Cricket gets Open Innings. Run entirely on donations, with
              every expense published transparently.
            </p>
      ...
      <footer className="border-t border-border py-8">
        <div className="container flex flex-col items-center justify-between gap-4 text-sm text-muted-foreground sm:flex-row">
          ...
          <p className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
            <span>AGPL-3.0</span>
            <a href="https://github.com/open-innings/open-innings" className="hover:text-foreground">
              GitHub
            </a>
...
function ScoreboardMockup() {
  return (
    <div className="relative mx-auto w-full max-w-md">
      <div
        className="absolute -inset-6 -z-10 rounded-[2rem] bg-gradient-to-br from-primary/20 via-pitch/20 to-transparent blur-2xl"
        aria-hidden
      />
      <Card className="overflow-hidden border-scoreboard-border bg-scoreboard text-scoreboard-text shadow-card-hover">
        <div className="flex items-center justify-between border-b border-scoreboard-border px-5 py-3">
        ...
        <div className="px-5 py-6">
          <div className="flex items-end justify-between">
            <div>
              <p className="text-sm text-scoreboard-muted">Boundary CC</p>
              <p className="text-5xl font-bold tabular-nums tracking-tight">
                142<span className="text-scoreboard-muted">/</span>3
              </p>
            </div>
            <div className="text-right text-sm text-scoreboard-muted">
              <p className="tabular-nums">16.4 ov · CRR 8.52</p>
              <p className="mt-1 text-scoreboard-accent">Need 19 off 20</p>
            </div>
          </div>
          <div className="mt-6 space-y-1.5 text-sm">
            <div className="flex justify-between">
              <span className="font-medium">▸ R. Sharma</span>
              <span className="tabular-nums text-scoreboard-muted">
                68 (41) · 4×6 <span className="text-scoreboard-text">·</span> 5×4
              </span>
            </div>
            <div className="flex justify-between text-scoreboard-muted">
              <span>K. Perera</span>
              <span className="tabular-nums">24 (19)</span>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-1.5 border-t border-scoreboard-border px-5 py-3">
          <span className="mr-1 text-xs uppercase tracking-wide text-scoreboard-muted">
            This over
          </span>
          <MockBall label="1" />
...
function MockBall({ label, className }: { label: string; className?: string }) {
  return (
    <span
      className={`inline-flex h-7 min-w-7 items-center justify-center rounded-full bg-scoreboard-panel px-1 text-[11px] font-bold tabular-nums ${className ?? ''}`}
    >
      {label}
    </span>
  );
...
function FeatureCard({
  ...
  return (
    <Card className="p-6 transition-shadow hover:shadow-card-hover">
      <span className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-md bg-accent text-accent-foreground">
        {icon}
      </span>
